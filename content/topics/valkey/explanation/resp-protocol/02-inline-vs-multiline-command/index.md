...
RESP 의 기본 요청 형식은 [[topics/valkey/concept/serialization-protocol-specification/array/index|multibulk(Array of Bulk Strings)]] 임 
...
그런데 [[topics/valkey/explanation/resp-protocol/01-connect-with-nc/index|이전 페이지]] 처럼 nc 에 평문으로 `set foo bar` 만 입력해도 동일하게 동작함
