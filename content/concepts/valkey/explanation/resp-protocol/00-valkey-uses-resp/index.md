...
> [!NOTE] valkey-server 가 6379 포트에서 동작 중이라고 가정 ([[guide/valkey-local-run/index|로컬에서 Valkey 실행하기]] 참고)
...
[[concepts/valkey/explanation/resp-protocol/01-connect-with-nc/index|다음 페이지]] 에서 `nc` 로 직접 접속해 명령을 보내봄
