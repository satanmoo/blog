...
[[concepts/valkey/explanation/resp-protocol/03-resp-v2-response-types/index|RESP v2]] 는 표현할 수 있는 타입이 적어서 (boolean, null, double 등을 별도로 표시할 수 없음) 풍부한 응답을 다루기 부족함
