...
각 구성요소가 어떤 역할을 하는지는 [[concepts/git/reference/gitrepository-layout/index|gitrepository-layout]] 참고
`git init`의 자세한 동작은 [[concepts/git/reference/init/index|git-init]] 참고
